            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">收费登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shoufeiName" name="shoufeiName" class="form-control"
                                               v-model="ruleForm.shoufeiName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>收费类型</label>
                                    <input id="shoufeiValue" name="shoufeiValue" class="form-control"
                                           v-model="ruleForm.shoufeiValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shoufeiYuMonry" name="shoufeiYuMonry" class="form-control"
                                               v-model="ruleForm.shoufeiYuMonry" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shoufeiShiMonry" name="shoufeiShiMonry" class="form-control"
                                               v-model="ruleForm.shoufeiShiMonry" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.shoufeiContent != null && ruleForm.shoufeiContent != 'null' && ruleForm.shoufeiContent != '') {
            var shoufeiContentUeditor = UE.getEditor('shoufeiContentEditor');
                shoufeiContentUeditor.ready(function () {
                    var mes = '' + ruleForm.shoufeiContent;
                    shoufeiContentUeditor.setContent(mes);
                    shoufeiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
