...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.fangjianContent != null && ruleForm.fangjianContent != 'null' && ruleForm.fangjianContent != '') {
            var fangjianContentUeditor = UE.getEditor('fangjianContentEditor');
                fangjianContentUeditor.ready(function () {
                    var mes = '' + ruleForm.fangjianContent;
                    fangjianContentUeditor.setContent(mes);
                    fangjianContentUeditor.setDisabled('fullscreen');
            });
        }
    }
