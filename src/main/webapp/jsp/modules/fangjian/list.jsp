    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(roomCell);
                ...
                //房间备注
            // var fangjianContentCell = document.createElement('td');
            // //如果图文详情包含图片
            // if (item.fangjianContent && item.fangjianContent.indexOf('img') != -1) {
            //     //暂时只考虑图片+文字 和 文字+图片的情况
            //     var beginIndex = item.fangjianContent.indexOf('<img');
            //     var endIndex = item.fangjianContent.indexOf('>');
            //         fangjianContentCell.innerHTML = item.fangjianContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            // } else {
            //     if (item.fangjianContent != null && item.fangjianContent != "" && item.fangjianContent.length >= 11) {
            //             fangjianContentCell.innerHTML = item.fangjianContent.substring(0, 10) + "...";
            //     } else {
            //             fangjianContentCell.innerHTML = item.fangjianContent;
            //     }
            // }
            // row.appendChild(fangjianContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("fangjian/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addfangjian", "addfangjian");
            window.location.href = "add-or-update.jsp"
        }
