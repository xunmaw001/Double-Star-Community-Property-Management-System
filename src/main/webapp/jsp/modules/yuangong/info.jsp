                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="yuangongFenshu" name="yuangongFenshu" class="form-control"
                                               v-model="ruleForm.yuangongFenshu" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.yuangongContent != null && ruleForm.yuangongContent != 'null' && ruleForm.yuangongContent != '') {
            var yuangongContentUeditor = UE.getEditor('yuangongContentEditor');
                yuangongContentUeditor.ready(function () {
                    var mes = '' + ruleForm.yuangongContent;
                    yuangongContentUeditor.setContent(mes);
                    yuangongContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var yuangongFileUrl = "download('" + ruleForm.yuangongFile + "')";
        $("#yuangongFile").attr("onclick", yuangongFileUrl);
