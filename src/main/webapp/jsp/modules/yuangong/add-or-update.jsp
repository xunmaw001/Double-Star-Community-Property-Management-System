                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 aaaaaa">
                                        <label>员工合同</label>
                                        <input name="file" type="file" class="form-control-file" id="yuangongFileupload">
                                        <label id="yuangongFileName"></label>
                                        <input name="yuangongFile" id="yuangongFile-input" type="hidden">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>入职考核分数</label>
...
<script>
    ...
    function setContent() {
        ...
        <!-- 当前表的填充富文本框 -->
        if (ruleForm.yuangongContent != null && ruleForm.yuangongContent != 'null' && ruleForm.yuangongContent != '' && $("#yuangongContentupload").length>0) {

            var yuangongContentUeditor = UE.getEditor('yuangongContentEditor');
            yuangongContentUeditor.ready(function () {
                var mes = '';
                if(ruleForm.yuangongContent != null){
                    mes = ''+ ruleForm.yuangongContent;
                    mes = mes.replace(/\n/g, "<br>");
                }
                yuangongContentUeditor.setContent(mes);
            });
        }
    }
    // 获取富文本框内容
    function getContent() {
        ...
        <!-- 获取当前表的富文本框内容 -->
        if($("#yuangongContentupload").length>0) {
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#yuangongFenshu").val(ruleForm.yuangongFenshu);
        $("#yuangongContent").val(ruleForm.yuangongContent);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
            $('#yuangongFenshu').attr('readonly', 'readonly');
        }else{
            // alert("未知情况.......");
        }
    }
